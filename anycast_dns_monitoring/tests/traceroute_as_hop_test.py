...
from anycast_dns_monitoring.data_processing.traceroute_as_hop import get_asn_path, get_probe_list, get_prefix_to_as, get_probe_as, get_traceroute_data


class TracerouteAsHopTest(unittest.TestCase):
    def setUp(self):
        self.peering_asn = '47065'
        self.probe_as_list = "../static/datasets/prb_as"
        self.prefix_as_list = "../static/datasets/block_to_as_summary"
        self.probe_list = "../static/datasets/prb_id_list"
        self.ripe_atlas_data = "../static/datasets/201602070600.json"
